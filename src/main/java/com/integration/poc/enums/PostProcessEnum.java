...
//  ACCOUNT_BILLING_CONVERSION("AccountBillingConversion", "src\\main\\resources\\lib\\account-billing-conversion-config.json", CSVMediatorImpl.class, CSVMediatorImpl.class),
  SHIPMENT_CONVERSION("ShipmentConversion", "src\\main\\resources\\lib\\shipment-config.json"),
  CUSTOMER_CONVERSION("CustomerConversion", "src\\main\\resources\\lib\\customer-config.json");
